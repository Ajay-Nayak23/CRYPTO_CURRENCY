...
import { MoneyCollectOutlined, DollarCircleOutlined, FundOutlined, ExclamationCircleOutlined, StopOutlined, TrophyOutlined,
     NumberOutlined, CheckOutlined, ThunderboltOutlined } from '@ant-design/icons';
...
const CryptoDetails = () => {
    ...
    console.log('cryptoDetails:', cryptoDetails); // Check the structure of cryptoDetails
    // console.log('coinHistory:', coinHistory); // Check the structure of coinHistory
        ...
        <Col className="coin-detail-container">
            <Col className="coin-heading-container">
                <Title level={2} className="coin-name">
                    {cryptoDetails?.name ?? 'N/A'} ({cryptoDetails?.symbol ?? 'N/A'}) Price
                </Title>
                <p>{cryptoDetails?.name ?? 'N/A'} live price in US Dollar (USD). View value statistics, market cap and supply.</p>
            </Col>
            <Select
                defaultValue="7d"
            ...
            <Col className="stats-container">
                <Col className="coin-value-statistics">
                    <Col className="coin-value-statistics-heading">
                        <Title level={3} className="coin-details-heading">{cryptoDetails?.name ?? 'N/A'} Value Statistics</Title>
                        <p>An overview showing the statistics of {cryptoDetails?.name ?? 'N/A'},
                ...
                <Col className="other-stats-info">
                    <Col className="coin-value-statistics-heading">
                        ...
                        <p>An overview showing the statistics of {cryptoDetails?.name ?? 'N/A'}, such as the base and quote currency, the rank, and trading volume.</p>
                    </Col>
            ...
            <Col className="coin-desc-link">
                ...
                <Col className="coin-links">
                    <Title level={3} className="coin-details-heading">{cryptoDetails?.name ?? 'N/A'} Links</Title>
